...
namespace NetSolutionWeb.Controllers
{
    ...
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TestimonialID,PersonName,Designation,CompanyName,TestimonialText")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TestimonialID,PersonName,Designation,CompanyName,TestimonialText")] Testimonial testimonial)
        {
