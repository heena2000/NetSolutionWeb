...
namespace NetSolutionWeb.Controllers
{
    ...
    public class CareersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CareerID,Name,EmailID,ContactNo,ExtName")] Career career)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CareerID,Name,EmailID,ContactNo,ExtName")] Career career)
        {
