...
namespace NetSolutionWeb.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailID = table.Column<string>(maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Industry = table.Column<string>(maxLength: 200, nullable: false),
                    Features = table.Column<string>(maxLength: 2000, nullable: false),
                    ExtName = table.Column<string>(maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TestimonialID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PersonName = table.Column<string>(maxLength: 200, nullable: false),
                    Designation = table.Column<string>(maxLength: 200, nullable: false),
                    CompanyName = table.Column<string>(maxLength: 200, nullable: false),
                    TestimonialText = table.Column<string>(maxLength: 2000, nullable: false)
                },
                constraints: table =>
                {
